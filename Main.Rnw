...
opts_chunk$set(dev='cairo_pdf',fig.width = 7, fig.asp = 1, echo = FALSE, result = "asis", out.width = "\\textwidth", size = 'small')

# Packages loadings
pkgs <- c("readr", "tidyr", "dplyr", "caret", "GGally", "ggfortify", 
          "ggthemes","bestglm")
